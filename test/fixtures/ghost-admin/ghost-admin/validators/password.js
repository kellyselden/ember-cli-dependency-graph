define('ghost-admin/validators/password', ['exports', 'ghost-admin/validators/base'], function (exports, _base) {
    'use strict';
    ...
    var BAD_PASSWORDS = ['1234567890', 'qwertyuiop', 'qwertzuiop', 'asdfghjkl;', 'abcdefghij', '0987654321', '1q2w3e4r5t', '12345asdfg'];
    var DISALLOWED_PASSWORDS = ['ghost', 'password', 'passw0rd'];
    ...
    exports.default = _base.default.extend({
        ...
        * @return {Boolean}
        */
        _characterOccurance: function _characterOccurance(stringToTest) {
            var chars = {};
            var allowedOccurancy = void 0;
            var valid = true;

            allowedOccurancy = stringToTest.length / 2;

            // Loop through string and accumulate character counts
            for (var i = 0; i < stringToTest.length; i += 1) {
        ...
        passwordValidation: function passwordValidation(model, password, errorTarget) {
            var _this = this;

            var blogUrl = model.get('config.blogUrl') || window.location.host;
            var blogTitle = model.get('blogTitle') || model.get('config.blogTitle');
            var blogUrlWithSlash = void 0;
            ...
            BAD_PASSWORDS.map(function (badPassword) {
            ...
            DISALLOWED_PASSWORDS.map(function (disallowedPassword) {
