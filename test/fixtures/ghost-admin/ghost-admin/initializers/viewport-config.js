define('ghost-admin/initializers/viewport-config', ['exports', 'ghost-admin/config/environment', 'ember-in-viewport/utils/can-use-dom'], function (exports, _environment, _canUseDom) {
  'use strict';
