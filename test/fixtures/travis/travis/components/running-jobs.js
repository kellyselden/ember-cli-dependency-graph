define('travis/components/running-jobs', ['exports', 'travis/mixins/polling', 'travis/config/environment', 'npm:visibilityjs', 'ember-decorators/service'], function (exports, _polling, _environment, _npmVisibilityjs, _service) {
  'use strict';
  ...
  exports.default = Component.extend(_polling.default, (_dec = (0, _service.service)('updateTimes'), (_obj = { store: null,
    updateTimesService: null,

    pollHook: function pollHook() {
