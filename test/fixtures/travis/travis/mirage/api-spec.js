define("travis/mirage/api-spec", ["exports"], function (exports) {
  "use strict";
  ...
  exports.default = {
    ...
    "errors": {
      ...
      "insufficient_access": {
        ...
        "additional_attributes": ["permission", "resource_type"]
      },
      "job_already_running": {
        "status": 409,
    ...
    "resources": {
      ...
      "beta_feature": {
        ...
        "actions": {
          "update": [{
            ...
            "accepted_params": ["beta_feature.id", "beta_feature.enabled"]
          }],
          "delete": [{
            "@type": "template",
        ...
        "representations": {
          "standard": ["id", "name", "description", "enabled", "feedback_url"]
        }
      },
      "beta_features": {
        "@type": "resource",
      ...
      "branch": {
        ...
        "representations": {
          "minimal": ["name"],
          "standard": ["name", "repository", "default_branch", "exists_on_github", "last_build"],
          "additional": ["recent_builds"]
        }
      },
      "branches": {
        "@type": "resource",
        ...
        "sortable_by": ["name", "last_build", "exists_on_github", "default_branch"],
      ...
      "broadcast": {
        ...
        "representations": {
          "minimal": ["id", "message", "created_at", "category", "active"],
          "standard": ["id", "id", "message", "created_at", "category", "active", "recipient"]
        }
      },
      "broadcasts": {
        "@type": "resource",
      ...
      "build": {
        ...
        "representations": {
          "minimal": ["id", "number", "state", "duration", "event_type", "previous_state", "pull_request_title", "pull_request_number", "started_at", "finished_at"],
          "standard": ["id", "number", "state", "duration", "event_type", "previous_state", "pull_request_title", "pull_request_number", "started_at", "finished_at", "repository", "branch", "commit", "jobs", "stages", "created_by"]
        },
        "permissions": ["read", "cancel", "restart"]
      },
      "builds": {
        "@type": "resource",
        "actions": {
      ...
      "caches": {
        ...
        "attributes": ["branch", "match"],
        "representations": {
          "standard": ["branch", "match"]
        }
      },
      "commit": {
        "@type": "resource",
        ...
        "representations": {
          "minimal": ["id", "sha", "ref", "message", "compare_url", "committed_at"],
          "standard": ["id", "sha", "ref", "message", "compare_url", "committed_at", "committer", "author"]
        }
      },
      "cron": {
        "@type": "resource",
        "actions": {
          ...
          "create": [{
            ...
            "accepted_params": ["cron.interval", "cron.dont_run_if_recent_build_exists", "cron.interval", "cron.dont_run_if_recent_build_exists"]
          }, {
            "@type": "template",
            "request_method": "POST",
        ...
        "representations": {
          "minimal": ["id"],
          "standard": ["id", "repository", "branch", "interval", "dont_run_if_recent_build_exists", "last_run", "next_run", "created_at"]
        },
        "permissions": ["read", "delete", "start"]
      },
      "crons": {
        "@type": "resource",
        "actions": {
      ...
      "env_var": {
        ...
        "representations": {
          "standard": ["id", "name", "value", "public"],
          "minimal": ["id", "name", "public"]
        },
      ...
      "error": {
        "@type": "resource",
        "actions": {},
        "attributes": ["error_type", "error_message", "resource_type", "permission"]
      },
      "home": {
        "@type": "resource",
        "actions": {
        ...
        "attributes": ["config", "errors", "resources"]
      },
      "job": {
        "@type": "resource",
        "actions": {
        ...
        "representations": {
          "minimal": ["id"],
          "standard": ["id", "number", "state", "started_at", "finished_at", "build", "queue", "repository", "commit", "owner", "stage", "allow_failure"]
        },
        "permissions": ["read", "debug", "cancel", "restart", "delete_log"]
      },
      "jobs": {
        "@type": "resource",
        "actions": {
      ...
      "key_pair": {
        ...
        "attributes": ["description", "public_key", "fingerprint", "value"],
        "representations": {
          "standard": ["description", "public_key", "fingerprint"],
          "minimal": ["description", "public_key", "fingerprint"]
        },
        "permissions": ["read", "write"]
      },
      "key_pair_generated": {
      ...
      "organization": {
        ...
        "representations": {
          "minimal": ["id", "login"],
          "standard": ["id", "login", "name", "github_id", "avatar_url"],
      ...
      "repositories": {
        ...
        "sortable_by": ["id", "github_id", "owner_name", "name", "active", "default_branch.last_build"]
      },
      "repository": {
        "@type": "resource",
        "actions": {
        ...
        "representations": {
          ...
          "standard": ["id", "name", "slug", "description", "github_language", "active", "private", "owner", "default_branch", "starred"]
        },
        "permissions": ["read", "admin", "activate", "deactivate", "star", "unstar", "create_cron", "create_env_var", "create_key_pair", "delete_key_pair", "create_request"]
      },
      "request": {
        "@type": "resource",
        "actions": {
        ...
        "representations": {
          "minimal": ["id", "state", "result", "message"],
          "standard": ["id", "state", "result", "message", "repository", "branch_name", "commit", "builds", "owner", "created_at", "event_type"]
        }
      },
      "requests": {
        "@type": "resource",
      ...
      "resource": {
        "@type": "resource",
        "actions": {},
        "attributes": ["actions", "attributes", "representations", "access_rights"]
      },
      "setting": {
        "@type": "resource",
        "actions": {
      ...
      "stage": {
        ...
        "representations": {
          "minimal": ["id", "number", "name", "state", "started_at", "finished_at"],
          "standard": ["id", "number", "name", "state", "started_at", "finished_at", "jobs"]
        }
      },
      "stages": {
        "@type": "resource",
      ...
      "template": {
        "@type": "resource",
        "actions": {},
        "attributes": ["request_method", "uri_template"]
      },
      "user": {
        "@type": "resource",
        "actions": {
        ...
        "representations": {
          "minimal": ["id", "login"],
          "standard": ["id", "login", "name", "github_id", "avatar_url", "is_syncing", "synced_at"],
          "additional": ["repositories"]
        },
        "permissions": ["read", "sync"]
      }
