define('ember-validators/exclusion', ['exports', 'ember', 'ember-validators/utils/validation-error'], function (exports, _ember, _emberValidatorsUtilsValidationError) {
  ...
  function validateExclusion(value, options, model, attribute) {
    ...
    if (array && array.indexOf(value) !== -1) {
      return (0, _emberValidatorsUtilsValidationError['default'])('exclusion', value, options);
    }
